...
public class RevisionManager {
	...
	public void checkIn(CheckedOutDocument checkedOutDocument,DocumentClass documentClass,Hashtable<String,String> indexRecord,File imageFile,String comments,String ext,String userName)throws Exception{
