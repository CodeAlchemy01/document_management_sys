...
public class EmailMessage {
	...
	public void send()throws Exception{
		try{
			...
			props.put("mail.smtp.host", "mail.krystaldms.in");
			...
			InternetAddress objSenAdd = new InternetAddress("no-reply@krystaldms.in","KRYSTAL DMS - Standard Edition Trial Version");
	...
	class PasswordAuthenticator extends Authenticator {
		public PasswordAuthentication getPasswordAuthentication() {
			return new PasswordAuthentication("no-reply@krystaldms.in","password1");
		}
	}
}
