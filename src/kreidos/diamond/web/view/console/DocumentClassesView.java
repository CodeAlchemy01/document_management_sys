...
public class DocumentClassesView extends WebView {
	...
	private void printBreadCrumbs() throws Exception{
		...
		out.println("<li class=\"active\">Document Classes</li>");
		out.println("</ol>");
	}
	...
	private void printDocumentClasses() throws Exception{
		...
		try {
			...
			out.println("<div class=\"panel-heading\"><h4><i class=\"fa fa-lg fa-folder-open\"></i> Document Classes</h4></div>");
			...
			if(documentClassList.size() > 0 ){
				...
				for(DocumentClass documentClass : documentClassList){
					...
					out.println("<a href=\"/console/opendocumentclass?classid="+ documentClass.getClassId()+"\"  class=\"text-danger\">");
					...
					if(acl.canCreate()){
						...
						out.println(" | <a href=\"/console/bulkupload?classid="+ documentClass.getClassId()+"\">Bulk Upload</a>");
					}
					out.println(" | <a href=\""+HTTPConstants.BASEURL+"/console/subscriptions?classid="+ documentClass.getClassId() + "\">Manage Subscriptions</a>");
					out.println(" | <a href=\"/console/documentclassproperties?classid="+documentClass.getClassId()+"\" data-toggle=\"modal\" data-target=\"#documentClassPropertiesModal\">Properties</a>");
					out.println("</h6></p>");
					out.println("</div>");
